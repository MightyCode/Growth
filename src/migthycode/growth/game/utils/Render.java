...
public class Render {
	...
	/**
	 * @brief Affiche une texture aux coordonnées choisis.
	 * On peut aussi choisir la transparance de la texture (alpha).
	 * @param posX Position en X.
	 * @param posY Position en Y.
	 * @param sizeX Taille de la texture en X.
	 * @param sizeY Taille de la texture en Y.
	 * @param textID Id de la texture.
	 * @param alpha Transparance de la texture.
	 */
