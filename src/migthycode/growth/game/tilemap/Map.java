...
public class Map {
	 ...
	 * Setters
	 */
	public void setIdPanel(int side, int i) {
		idMapNeightbour[side - 1] = i;
	}
	...
	public double getTileToComeX(int side) {
		return tileToCome[side - 1][0];
	}

	public double getTileToComeY(int side) {
